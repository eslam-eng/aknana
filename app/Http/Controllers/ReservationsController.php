...
class ReservationsController extends Controller
{
    ...
    {
        $courses = Course::all();
        $temp_reservations = Template::where('name->en', 'Masa_Week')->get();
        ...
        $header = Header::first();
        $footer = Footer::first();
        return view('contactUs.createReservation', compact('availableCourses', 'temp_reservations' ,'selectedCourse', 'header','footer'));
    }
