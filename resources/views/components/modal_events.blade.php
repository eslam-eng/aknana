               ...
               <div class="modal-content">
                   <div class="modal-body">
                       <div class="center pr-0 text-left">
                           ...
                           <span
                               style="font-family: Cairo;color: #091157; font-size: 20px; font-weight: 667; line-height: 45px; letter-spacing: -0.01em; text-align: end;">
               ...
               <div class="modal-content">
                   <div class="modal-body">
                       <div class="center pr-0 text-right">
                           <img src="{{ asset('images/Vector (1).svg') }}">
                           <span
                               style="font-family: Cairo;color: #091157; font-size: 20px; font-weight: 667; line-height: 45px; letter-spacing: -0.01em; text-align: start;">
                               <span id="event-full-text-title"></span>
                           </span>
                       </div>
                       <p id="event-full-text" class="mt-3"
