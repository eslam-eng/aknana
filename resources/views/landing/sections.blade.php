...
@section('content')
            ...
            <div class=" 1 row d-flex justify-content-center mb-2">
                ...
                text-align: center;">
                    ...
                    text-align: center;
                        ...
                        <div id="textd" class=" service_text1"
                    ...
                    color:#7B7B7B;
                    ">
                            {!! $template->getTranslation('main_text', 'en') !!}</div>
                    </div>
                @endforeach
            </div>
                    ...
                    <div class="col-md-2 mb-5">
                        <div class="d-flex justify-content-center align-items-center mt-5 mb-5">
                            ...
                            <img src="{{ asset('storage/' . $service->media()->first()->file_path) }}" alt="Service Image"
                                style="width: 168px; height: 168px; border-radius: 50%; z-index: 1;">
                        </div>
        ...
        @else
            <div class=" 1 row d-flex justify-content-center mb-2">
                ...
                text-align: center;">
                    ...
                    color:#7B7B7B;
                    ">
                            {!! $template->getTranslation('main_text', 'ar') !!}</div>
                    </div>
                @endforeach
            </div>
    ...
    <section id="US" class="US container text-center "
        style="max-width: 1400px;margin-top: 8rem !important;margin-bottom: 5rem !important; ">
        @if (app()->getLocale() == 'ar')
            <div class="row  custom-row-style">
                @foreach ($temp_US as $template)
                    <div class="col-md-6 d-flex justify-content-start">
                        <img src="{{ asset('storage/' . $template->image) }}" width="90%" height="95%"
        ...
        @else
            <div class="row d-flex justify-content-between custom-row-style">
                @foreach ($temp_US as $template)
                    <div class="col-md-6 d-flex justify-content-start">
                        <img src="{{ asset('storage/' . $template->image_ar) }}"width="90%" height="90%"
                            class="custom-image-style">
                    </div>
                    <div class="col-md-6 ">
                        <p class="center mb-3 custom-text-style "
    ...
    <section class="2030 container" style="max-width: 1400px;margin-bottom: 7rem !important; " id="2030">
        @if (app()->getLocale() == 'ar')
            @foreach ($temp_2023 as $template)
                <div class="row d-flex justify-content-between mb-5">
                    ...
                    <div class="col-md-6 d-flex justify-content-end ">
                        <img src="{{ asset('storage/' . $template->image) }}"width="90%" height="90%"
                            class="custom-image-style">
                    </div>
                </div>
            @endforeach
                    ...
                    <div class="row" style="margin-bottom: 20px;">
                        <div class="col-md-6">
                            <div class="card " id="card6"
                                style="max-height: 300px;margin-top:25px;border-radius: 20px; border: #E6E6E6 1px solid; background: #FFFFFF;">
                                <div class="card-body text-left">
                                    <div>
            ...
            <div class="row justify-content-center mt-10 mb-7">
                ...
                <div class="col-md-6 order-0 order-md-1 animate-fade-in">
                    ...
                    <div class="d-flex justify-content-end " style="gap: 30px;margin-top: -70px;
                        ...
                        <!-- Card 4 -->
                        <div class="card"
                            style=" margin-top:80px;width:100%;max-height: 300px; border-radius: 20px; background: #121743;">
                        ...
                        <!-- Card 3 -->
                        <div class="card"
                            style="margin-top:80px;width:100%;max-height: 300px; border-radius: 20px; border: #E6E6E6 1px solid; background: #FFFFFF;">
                            <div class="card-body text-right">
                                <div>
                                    <img src="{{ asset('storage/' . $range7->media()->first()->file_path) }}"
                                        alt="Icon Image" width="50px" height="50px">
    ...
    <style>
     @media only screen and (max-width: 600px) { /* Adjust max-width as per your design */
         .custom-image-style {
            width:585px; height:378px
        }
        #card6{
            width:270px;
